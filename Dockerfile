...
# Include Debian equivalents of the missing packages
RUN apt-get update && apt-get install -y \
    ...
    libgdk-pixbuf-2.0-0 fonts-unifont fonts-ubuntu \
...
# Install Playwright browsers without dependency installation (we already have them)
